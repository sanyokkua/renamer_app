...
import ua.renamer.app.core.commands.preparation.ImageDimensionsPrepareInformationCommand;
...
import ua.renamer.app.ui.converters.ImageDimensionOptionsConverter;
...
public class ModeUseImageDimensionsController extends ModeBaseController {
    ...
    private void configLeftDimensionChoiceBox() {
        ...
        leftDimensionChoiceBox.setConverter(new ImageDimensionOptionsConverter());
    ...
    private void configRightDimensionChoiceBox() {
        ...
        rightDimensionChoiceBox.setConverter(new ImageDimensionOptionsConverter());
