...
import ua.renamer.app.core.commands.preparation.SequencePrepareInformationCommand;
import ua.renamer.app.core.enums.SortSource;
import ua.renamer.app.ui.abstracts.ModeBaseController;
import ua.renamer.app.ui.converters.SortSourceConverter;
...
public class ModeAddSequenceController extends ModeBaseController {
    ...
    private void configSortingSourceChoiceBox() {
        ...
        sortingSourceChoiceBox.setConverter(new SortSourceConverter());
    }
