...
class ChangeCasePreparePrepareInformationCommandTest extends BaseRenamePreparationCommandTest {
    ...
    static Stream<Arguments> provideCommandArguments() {
        ...
        return Stream.of(
                ...
                arguments("this_is-a_file name", "thisIsAFileName", ".jpg", ".jpg", false, TextCaseOptions.CAMEL_CASE, false),
                arguments("this_is-a_file name", "ThisIsAFileName", ".jpg", ".jpg", false, TextCaseOptions.PASCAL_CASE, false),
                arguments("this_is-a_file name", "this_is_a_file_name", ".jpg", ".jpg", false, TextCaseOptions.SNAKE_CASE, false),
                arguments("this_is-a_file name", "THIS_IS_A_FILE_NAME", ".jpg", ".jpg", false, TextCaseOptions.SNAKE_CASE_SCREAMING, false),
                arguments("this_is-a_file name", "this-is-a-file-name", ".jpg", ".jpg", false, TextCaseOptions.KEBAB_CASE, false),
                arguments("this_is-a_file name", "THIS_IS-A_FILE NAME", ".jpg", ".jpg", false, TextCaseOptions.UPPERCASE, false),
                arguments("this_is-a_file name", "this_is-a_file name", ".jpg", ".jpg", false, TextCaseOptions.LOWERCASE, false),
                arguments("this_is-a_file name", "This Is A File Name", ".jpg", ".jpg", false, TextCaseOptions.TITLE_CASE, false),

                arguments("fileNameOriginal", "FileNameOriginal", ".jpg", ".jpg", false, TextCaseOptions.CAMEL_CASE, true),
                arguments("file Name Original", "File_name_original", ".jpg", ".jpg", false, TextCaseOptions.SNAKE_CASE, true)
                        );
        // @formatter:on
    }
    ...
    void commandExecution_ShouldChangeCase(String originalName, String expectedName, String originalExt, String expectedExt, boolean isFile, TextCaseOptions textCaseOptions, boolean capitilize) {
        // Prepare Test Data
