...
class TimeFormat(IntEnum):
    ...
    HH_MM_24 = 6
    HH_MM_24_TOGETHER = 7
    HH_MM_24_WHITE_SPACED = 8
    HH_MM_24_UNDERSCORED = 9
    HH_MM_24_DOTTED = 10
    HH_MM_24_DASHED = 11
    HH_MM_SS_AM_PM_TOGETHER = 12
    HH_MM_SS_AM_PM_WHITE_SPACED = 13
    HH_MM_SS_AM_PM_UNDERSCORED = 14
    HH_MM_SS_AM_PM_DOTTED = 15
    HH_MM_SS_AM_PM_DASHED = 16
    HH_MM_AM_PM_ = 17
    HH_MM_AM_PM_TOGETHER = 18
    HH_MM_AM_PM_WHITE_SPACED = 19
    HH_MM_AM_PM_UNDERSCORED = 20
    HH_MM_AM_PM_DOTTED = 21
    HH_MM_AM_PM_DASHED = 22
