...
datetime_20221025_151210 = datetime(2022, 10, 25, 15, 12, 10)  # 20221025_151010
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            datetime_20221025_151010_ts,
            True,
            datetime(2008, 11, 22, 11, 59, 00).timestamp(),
            "20081122_115900",
            False,
        ),
        (
...
def test_command_params_combinations_for_fallback(
    ...
    test_command = DateTimeRenamePrepareCommand(
        ...
        datetime_format=DateTimeFormat.DATE_TIME_UNDERSCORED,
        datetime_source=dts,
        use_fallback_date_timestamp=custom_datetime,
