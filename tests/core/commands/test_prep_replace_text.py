...
@pytest.mark.parametrize("position, text_to_replace, new_value, file_name, exp_name, has_changes", [
    (ItemPositionExtended.BEGIN, "text_to_replace", "new_value", "file_name", "file_name", False),
    (ItemPositionExtended.BEGIN, "", "new_value", "file_name", "file_name", False),
    (ItemPositionExtended.BEGIN, "", "", "file_name", "file_name", False),
    (ItemPositionExtended.END, "text_to_replace", "new_value", "file_name", "file_name", False),
    (ItemPositionExtended.END, "", "new_value", "file_name", "file_name", False),
    (ItemPositionExtended.END, "", "", "file_name", "file_name", False),
    (ItemPositionExtended.EVERYWHERE, "text_to_replace", "new_value", "file_name", "file_name", False),
    (ItemPositionExtended.EVERYWHERE, "", "new_value", "file_name", "file_name", False),
    (ItemPositionExtended.EVERYWHERE, "", "", "file_name", "file_name", False),
    (ItemPositionExtended.BEGIN, "to_replace", "new_value", "to_replace_file_name", "new_value_file_name", True),
    (ItemPositionExtended.END, "to_replace", "new_value", "file_name_to_replace", "file_name_new_value", True),
    (ItemPositionExtended.BEGIN, "AVA", "TT", "AVA_fileAVA_nameAVA", "TT_fileAVA_nameAVA", True),
    (ItemPositionExtended.END, "AVA", "TT", "AVA_fileAVA_nameAVA", "AVA_fileAVA_nameTT", True),
    (ItemPositionExtended.EVERYWHERE, "AVA", "TT", "AVA_fileAVA_nameAVA", "TT_fileTT_nameTT", True),
    (ItemPositionExtended.EVERYWHERE, "AVA", "", "AVA_fileAVA_nameAVA", "_file_name", True),
])
def test_extension_change_commands(position: ItemPositionExtended, text_to_replace, new_value: str, file_name: str,
                                   exp_name: str,
                                   has_changes: bool):
    from core.commands.prep_replace_text import ReplaceTextPrepareCommand
