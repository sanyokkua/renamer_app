...
@pytest.mark.parametrize("date_format, expected_date_string", [
...
@pytest.mark.parametrize("time_format, expected_time_string", [
...
@pytest.mark.parametrize("date_time_format, date_format, time_format, expected_output", [
    (DateTimeFormat.DATE_TIME_TOGETHER, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "19901205113322"),
    (DateTimeFormat.DATE_TIME_WHITE_SPACED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "19901205 113322"),
    (DateTimeFormat.DATE_TIME_UNDERSCORED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "19901205_113322"),
    (DateTimeFormat.DATE_TIME_DOTTED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "19901205.113322"),
    (DateTimeFormat.DATE_TIME_DASHED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "19901205-113322"),
    (DateTimeFormat.REVERSE_DATE_TIME_TOGETHER, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "11332219901205"),
    (DateTimeFormat.REVERSE_DATE_TIME_WHITE_SPACED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "113322 19901205"),
    (DateTimeFormat.REVERSE_DATE_TIME_UNDERSCORED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "113322_19901205"),
    (DateTimeFormat.REVERSE_DATE_TIME_DOTTED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "113322.19901205"),
    (DateTimeFormat.REVERSE_DATE_TIME_DASHED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.HH_MM_SS_24_TOGETHER,
     "113322-19901205"),
    (DateTimeFormat.NUMBER_OF_SECONDS_SINCE_JANUARY_1_1970, DateFormat.YYYY_MM_DD_TOGETHER,
     TimeFormat.HH_MM_SS_24_TOGETHER, f"{timestamp}"),
    (DateTimeFormat.DATE_TIME_TOGETHER, DateFormat.DO_NOT_USE_DATE, TimeFormat.HH_MM_SS_24_TOGETHER, "113322"),
    (DateTimeFormat.DATE_TIME_WHITE_SPACED, DateFormat.DO_NOT_USE_DATE, TimeFormat.HH_MM_SS_24_TOGETHER, "113322"),
    (DateTimeFormat.DATE_TIME_UNDERSCORED, DateFormat.DO_NOT_USE_DATE, TimeFormat.HH_MM_SS_24_TOGETHER, "113322"),
    (DateTimeFormat.DATE_TIME_DOTTED, DateFormat.DO_NOT_USE_DATE, TimeFormat.HH_MM_SS_24_TOGETHER, "113322"),
    (DateTimeFormat.DATE_TIME_DASHED, DateFormat.DO_NOT_USE_DATE, TimeFormat.HH_MM_SS_24_TOGETHER, "113322"),
    (DateTimeFormat.DATE_TIME_TOGETHER, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.DO_NOT_USE_TIME, "19901205"),
    (DateTimeFormat.DATE_TIME_WHITE_SPACED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.DO_NOT_USE_TIME, "19901205"),
    (DateTimeFormat.DATE_TIME_UNDERSCORED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.DO_NOT_USE_TIME, "19901205"),
    (DateTimeFormat.DATE_TIME_DOTTED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.DO_NOT_USE_TIME, "19901205"),
    (DateTimeFormat.DATE_TIME_DASHED, DateFormat.YYYY_MM_DD_TOGETHER, TimeFormat.DO_NOT_USE_TIME, "19901205"),
])
def test_make_datetime_string(date_time_format: DateTimeFormat, date_format: DateFormat, time_format: TimeFormat,
                              expected_output: str):
